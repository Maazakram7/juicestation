    ...
    <>
      ...
      >
        ...
        <div className="p-7 md:p-8">
          ...
          <p
            className="text-[13px] leading-relaxed opacity-75 mb-6 border-l-2 pl-4 py-1"
          ...
          <div className="flex items-center justify-between gap-3 pt-4 border-t border-current/10">
            ...
            <motion.button
              ...
              className="relative w-12 h-12 rounded-full bg-brand-charcoal dark:bg-brand-cream text-brand-cream dark:text-brand-charcoal flex items-center justify-center transition-colors"
            >
              <motion.span
